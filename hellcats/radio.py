...
class RadioChatter:
    ...
    CARRIER_CALLS = {
        ...
        'grade_s':   ["LSO: Perfect pass! Grade S — textbook trap!",
                       "Paddles: Outstanding! Put it in the ready room log."],
        'grade_a':   ["LSO: Grade A. Solid approach, good pass.",
                       "Tower: Good work. Clean trap on wire {wire}."],
        'grade_b':   ["LSO: Grade B. Acceptable — work on your speed.",
                       "Paddles: You're aboard. Tighten up next pass."],
        'grade_c':   ["LSO: Grade C. Fair pass — check the NATOPS.",
                       "LSO: You're on board, but that was marginal."],
